	...
	<div class="row page-body">
		...
		<div class="tabs-content create-offer">
			<div class="content active" id="range">
				{!! Form::open(array('method'=>'put', 'route'=>array('admin.offer.update', $offer->id))) !!}
					<div class="row">
						<div class="medium-2 columns">
							<label for="offerName" class="right inline">Offer Name</label>
						</div>
						<div class="medium-5 end columns">
							<input type="text" name="offer_name" value="{{ $offer->offer_name }}" id="offerName">
						</div>
					</div>
					<div class="row">
						<div class="medium-2 columns">
						...
						<div class="medium-5 end columns">
							<textarea name="description" id="desc" cols="30" rows="3">{{ $offer->description }}</textarea>
						</div>
					</div>
					<div class="row">
						<div class="medium-2 columns">
						...
						<div class="medium-2 end columns">
							<input type="text" name="start_date" id="start_date" value="{{ $dates['start'] }}" >
						</div>
					</div>
					<div class="row">
						<div class="medium-2 columns">
						...
						<div class="medium-2 end columns">
							<input type="text" name="end_date" id="end_date" value="{{ $dates['end'] }}">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="medium-10 columns">
							<input type="radio" value="1" name="offer_type" id="of_per"
								@if( $offer->offer_type == 1)
									checked
								@endif
							><label for="of_per">percentage</label>
							<input type="radio" value="2" name="offer_type" id="of_rs"
								@if( $offer->offer_type == 0)
									checked
								@endif
							><label for="of_rs">rupees</label>
						</div>
					</div>
					<div class="row">
						<div class="medium-2 columns">
						...
						<div class="medium-5 end columns">
							<input type="text" id="amount" name="amount" value="{{ $offer->amount }}">
						</div>
					</div>
					<div class="row">
						<div class="medium-2 columns">
					...
					<div class="row">
						...
						<div class="medium-2 end columns">
							<p class="text-right">
								<input type="submit" class="button tiny" value="Update Offer">
							</p>
						</div>
					</div>
				{!! Form::close(); !!}
...
@section ('scriptsContent')
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			// 	$('#sel_product').select2(productLists, {id:1, text:'Milk'});
