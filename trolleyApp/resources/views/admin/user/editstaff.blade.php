...
@section ('content')
	...
	<div class="row page-body">
		{!! Form::open(array('method'=>'put', 'route'=>array('admin.updatestaff', $staff->id))) !!}
		<div class="medium-12 end columns">			
			<div class="row">
				<div class="medium-2 columns">
					<label for="name" class="right inline">Staff Name</label>
				</div>
			...
			<div class="row">
				<div class="medium-2 columns">
					<label for="mobile" class="right inline">Admin Name</label>
				</div>
				<div class="medium-5 end columns">
			...
			<div class="row">
				<div class="medium-2 columns">
					<label for="email" class="right inline">Staff Email</label>
				</div>
				<div class="medium-5 end columns">
